...
// Nhiệm vụ của function này là: Push columnId vào cuối mảng columnOrderIds
...
// Dùng $pull trong mongodb ở trường hợp này để lấy một phần tử ra khỏi rồi xoá nó đi
    ...
    const query = await GET_DB().collection(BOARD_COLLECTION_NAME).aggregate(
      [
        ...
        { $facet: {
          ...
          // Luồng 02: Query đến tổng số lượng bản ghi board trong DB và trả về
